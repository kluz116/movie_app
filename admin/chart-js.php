		...
		<div class="theme-panel theme-panel-lg">
			...
			<div class="theme-panel-content">
				...
				<div class="theme-version">
					...
					<a href="https://seantheme.com/color-admin-v4.3/admin/transparent/index_v2.html">
						<span style="background-image: url(../assets/img/theme/transparent.jpg);"></span>
					</a>
				</div>
				<div class="theme-version">
					<a href="https://seantheme.com/color-admin-v4.3/admin/apple/index_v2.html">
						<span style="background-image: url(../assets/img/theme/apple.jpg);"></span>
					</a>
					<a href="https://seantheme.com/color-admin-v4.3/admin/material/index_v2.html">
						<span style="background-image: url(../assets/img/theme/material.jpg);"></span>
					</a>
				</div>
				<div class="theme-version">
					<a href="https://seantheme.com/color-admin-v4.3/admin/facebook/index_v2.html">
